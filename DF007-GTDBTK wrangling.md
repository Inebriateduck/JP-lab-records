Using GTDBTK to examine our datasets because I am desperate for data at this point. Created a script that operates within the quackers apptainer to loop through and process all the bins from the metawrap out (run at 70, 10 cutoffs) and dump the results into the corresponding directory. 
```
placeholder
```
